...
_ZONES = (
    ("Near post", 94.2, 20.0, 100.0, 43.0),
    ("Far post", 94.2, 57.0, 100.0, 80.0),
    ("6-yard centre", 94.2, 43.0, 100.0, 57.0),
    ("Penalty spot", 88.0, 43.0, 94.2, 57.0),
    ("Box right", 83.0, 20.0, 94.2, 43.0),
    ("Box left", 83.0, 57.0, 94.2, 80.0),
...
_CORNER_ZONES = (
    ("Six Yard", 94.2, 43.0, 100.0, 57.0, "#B59B3A", 0.60),      # just beyond the goalposts
    ("Penalty Spot", 83.0, 43.0, 94.2, 57.0, "#2E8B57", 0.55),
    ("Near Post Short", 83.0, 2.0, 100.0, 20.0, "#2E6E8E", 0.30),
    ("Near Post", 83.0, 20.0, 100.0, 43.0, "#2E6E8E", 0.48),
    ("Far Post", 83.0, 57.0, 100.0, 80.0, "#3E5C8A", 0.48),
